...
<html>
  <head>
    ...
    <title>DetallesMH | Sistema</title>
    ...
    <link rel="apple-touch-icon" href="{{asset('img/regalo1.png')}}">
    <link rel="shortcut icon" href="{{asset('img/regalo.ico')}}">
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="{{route('home')}}" class="logo">
          ...
          <span class="logo-lg"><b>DetallesMH</b></span>
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <small class="bg-pink">Activo</small>
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      SISTEMA DE VENTAS    - DetallesMH
                      <small>CindyMorales|AndreaRodas</small>
                    </p>
                  </li>
            ...
            <!-- <li class="treeview">
             ...
             <!-- <li>
              <a href="#">
                ...
                <small class="label pull-right bg-pink">PDF</small>
              </a>
            </li>
            <li>
              <a href="#">
            ...
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">Sistema de Ventas | DetallesMH</h3>
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2021 <a href="#">DetallesMH</a>. CindyMorales|AndreaRodas</strong> All rights reserved.
      </footer>
